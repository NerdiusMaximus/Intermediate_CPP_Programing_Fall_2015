...
THIS VERSION CHANGES TO ONE MEMBER FUNCTION WITH DEFAULTED VALUES

Does this change the main function? NO, the main function remains the same :)
*/
...
class X 
{
	...
	public:
	void setval(int Value1 = 0, int Value2 = 0, int Value3 = 0); //sets all values
